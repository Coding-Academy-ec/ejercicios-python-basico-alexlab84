...
def imprimir_nombre(nombre):
    print("Tu nombre es:", nombre)  # Se imprime el nombre en la pantalla
...
def imprimir_datos_personales(nombre, edad, estatura):
    print("Nombre:", nombre)  # Se imprime el nombre
    print("Edad:", edad)  # Se imprime la edad
    print("Estatura:", estatura)  # Se imprime la estatura
...
if __name__ == "__main__":
    ...
    edad = 30
    estatura = 1.75
    z = imprimir_datos_personales(nombre, edad, estatura)
...
if __name__ == "__main__":
    ...
    area_circulo(radio)  # Se llama a la función area_circulo() para calcular y mostrar el área del círculo

# 6 Define una función que reciba dos números como argumentos y devuelva su suma.
def suma(a, b):
    suma = a + b  # Se calcula la suma de los dos números
    return suma  # Se devuelve el resultado de la suma
